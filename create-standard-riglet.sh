...
then
  ...
  echo "Y" | make create-build REPO=twig-api REPO_BRANCH=master CONTAINER_PORT=3000 LISTENER_RULE_PRIORITY=100
#  echo "Y" | make create-build REPO=twig REPO_BRANCH=master CONTAINER_PORT=4200 LISTENER_RULE_PRIORITY=200
fi
